...
/**
 * Formats a given date in Y-m-d format
...
function checkSize() {
	...
	if ((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i)) || (navigator.userAgent.match(/iPad/i))) {
			...
			$("#topbar").removeClass('navbar-fixed-top').css(
				'width',
				'100%'
			).css(
				'margin-top',
...
function hide_social_media_bar() {
			$('#social_media_bar').hide(500);
				$.post("<?=base_url()?>home/close_social_media_bar", {}, function () {
			});
	}
...
// jquery highligh effect of flash message div
$( document ).ready(function() {
	var options = {};
  $( "#flashMessage" );
});
...
/**
 * jquery-ui-1.10.3.custom-highlight.min.js
 */
