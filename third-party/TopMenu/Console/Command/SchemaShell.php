 ...
 */
	protected function _update(&$Schema, $table = null) {
		...
		$update = (
			$this->in(
				__d('cake_console', 'Are you sure you want to alter the tables?'),
				array('y', 'n'),
				'n'
			) === 'y'
		);
 ...
 */
	public function getOptionParser() {
		...
		$nodrop = array(
			'help' => __d('cake_console', 'Create tables, but don\'t drop them.'),
			'boolean' => true
		);
		$force = array(
			'short' => 'f',
		...
		$parser->description(
			...
			'parser' => array(
				'options' => compact('plugin', 'path', 'file', 'name', 'connection', 'dry', 'snapshot', 'nodrop'),
				'args' => array(
					'name' => array(
