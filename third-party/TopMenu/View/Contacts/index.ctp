<div id="content_inner">
    <div class="other_center">
        ...
        <div class="location_view">
            <ul>
                <li>
                    <a href="javascript:void(0)" onclick="return popitup('http://www.providesupport.com/?messenger=topmenuweb')">
                        <i class="icon-comment" style="margin-right:3px;"></i><?php echo __('Chat with our customer service'); ?>
                    </a>
                </li>
                <li>
                     <?php
                    echo $this->Html->link(__('Send us an email'), 
                        array('controller' => 'contacts', 'action' => 'form'),
