<div class="actions columns col-lg-2 col-md-3">
    ...
    <ul class="nav nav-stacked nav-pills">
        <li><?= $this->Html->link(__('Edit Leasestype'), ['action' => 'edit', $leasestype->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Leasestype'), ['action' => 'delete', $leasestype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $leasestype->id), 'class' => 'btn-danger']) ?> </li>
...
<div class="leasestypes view col-lg-10 col-md-9 columns">
    <h2><?= h($leasestype->id) ?></h2>
    <div class="row">
        <div class="col-lg-5 columns strings">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h6 class="subheader"><?= __('Type Lease') ?></h6>
                    <p><?= h($leasestype->type_lease) ?></p>
                </div>
            </div>
        </div>
        <div class="col-lg-2 columns numbers end">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <p><?= $this->Number->format($leasestype->id) ?></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="related row">
    ...
    <?php if (!empty($leasestype->applications_leases)): ?>
    <div class="table-responsive">
        <table class="table">
            ...
            <?php foreach ($leasestype->applications_leases as $applicationsLeases): ?>
            <tr>
