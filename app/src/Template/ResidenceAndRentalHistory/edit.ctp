<div class="actions columns col-lg-2 col-md-3">
    ...
    <ul class="nav nav-stacked nav-pills">
        <li class="active disabled"><?= $this->Html->link(__('Edit Residence And Rental History'), ['action' => 'edit', $residenceAndRentalHistory->id]) ?> </li>
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $residenceAndRentalHistory->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $residenceAndRentalHistory->id), 'class' => 'btn-danger']
            )
        ?></li>
...
<div class="residenceAndRentalHistory form col-lg-10 col-md-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Residence And Rental History') ?></legend>
        <?php
