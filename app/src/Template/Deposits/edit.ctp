<div class="actions columns col-lg-2 col-md-3">
    ...
    <ul class="nav nav-stacked nav-pills">
        <li class="active disabled"><?= $this->Html->link(__('Edit Deposit'), ['action' => 'edit', $deposit->id]) ?> </li>
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $deposit->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $deposit->id), 'class' => 'btn-danger']
            )
        ?></li>
