...
class ApplicationsLeasesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => 'Fixed', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'recurring_charges_frequency' => ['type' => 'string', 'length' => 40, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'next_due_date' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'rent' => ['type' => 'string', 'length' => 40, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
...
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'next_due_date' => '2015-04-21',
            'rent' => 'Lorem ipsum dolor sit amet',
            'security_deposit' => '',
            'security_deposit_date' => '2015-04-21',
